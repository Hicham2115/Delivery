...
import { Box, Hexagon, LayoutDashboard, PackagePlus, Package } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { label: "Ajouter colis", href: "/dashboard/colis/new", icon: PackagePlus },
  { label: "Liste des colis", href: "/dashboard/colis", icon: Package },
];
